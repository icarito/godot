...
def get_opts():
	...
	return [
		...
		BoolVariable('frt_desktop_gl', 'Use a desktop OpenGL context instead of OpenGL ES', False),
...
def configure_misc(env):
	...
	if env['frt_desktop_gl']:
		env.Append(CPPDEFINES=['OPENGL_ENABLED', 'GLAD_ENABLED', 'GLES_OVER_GL'])
