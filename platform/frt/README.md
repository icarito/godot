...
as a stopgap you can try some experimental builds that you can find
among the [releases](https://github.com/efornara/frt/releases).
They are the ones with the -trixie suffix.
